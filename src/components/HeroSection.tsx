  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-6 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        <motion.p
          className="text-xl md:text-3xl text-muted-foreground max-w-3xl mx-auto mb-8"
          initial={{ opacity: 0, y: 40 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          >
            ...
            <span className="text-sm">GeForce 210</span>
          </motion.div>
          <motion.div 
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/50 border border-border"
            whileHover={{ scale: 1.05, backgroundColor: "hsl(var(--accent) / 0.1)" }}
        ...
        >
          <motion.div 
            className="relative p-1 rounded-2xl border-gradient glow-subtle"
